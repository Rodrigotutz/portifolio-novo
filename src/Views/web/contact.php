...
<section class="container mt-5">
    <div style="min-height: 100vh;"  class="row justify-content-center align-items-center">
        <div class="col-12 col-md-7 d-flex justify-content-center">
            <form class="form-outline" style="width: 30rem;">
                <h2 class="mb-2 text-center">Me envie um e-mail!</h2>
                ...
                <div class="text-center">
                    <button type="button" class="btn btn-outline-light mb-4"><i class="bi bi-send-fill"></i> Enviar mensagem</button>
                </div>
            </form>
        </div>
